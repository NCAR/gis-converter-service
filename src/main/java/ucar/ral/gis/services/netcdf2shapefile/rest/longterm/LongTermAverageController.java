...
public class LongTermAverageController {
	...
	@RequestMapping(value="/{scale}/{variable}/{scenario}/longterm/average/monthly/{term}/{season}")
	...
	@RequestMapping(value="/{scale}/{variable}/{scenario}/longterm/average/monthly/{term}/{season}.shp")
	...
	@RequestMapping(value="/{scale}/{variable}/{scenario}/longterm/average/monthly/{term}/{season}.txt")
	...
	@RequestMapping(value="/{scale}/{variable}/{scenario}/longterm/average/annual/{season}")
	...
	@RequestMapping(value="/{scale}/{variable}/{scenario}/longterm/average/annual/{season}.shp")
	...
	@RequestMapping(value="/{scale}/{variable}/{scenario}/longterm/average/annual/{season}.txt")
